...
지정한 디렉토리에서 **300kb를 초과하는 JPG/PNG 이미지를 자동으로 압축**하는 Node.js 스크립트입니다.

터미널에서 직접 실행하거나, Claude Code · Cursor 등 AI 코딩 툴의 스킬로 등록해 자연어 명령으로 실행할 수 있습니다.
...
```bash
# 터미널에서 바로 쓸 경우
git clone https://github.com/flo-olive/image-compress

# Claude Code 스킬로 등록할 경우
